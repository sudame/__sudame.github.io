document.addEventListener('DOMContentLoaded', () => {
    ...
    function setContent() {
        if (i <= 0) {
            document.querySelector('.button.prev').classList.add('hidden');
            document.querySelector('.order').classList.remove('hidden');
        }
        else {
            document.querySelector('.button.prev').classList.remove('hidden');
            document.querySelector('.order').classList.add('hidden');
        }

        if (i >= DATA.length - 1) {
            document.querySelector('.button.forw').classList.add('hidden');
        }
